...
+function ($, window) {
  ...
  app.dir = {
    home: app.corejs.replace('dashboard/js/core.min.js', ''),
...
+function ($) {
  ...
  provider.initDatatables = function () {
    ...
    provider.provide('custom_datatables', function () {
      $(this).DataTable({
        dom: 'lBfrtip <"actions">',
        buttons: [
          {
        ...
        lengthMenu: [10, 15, 20, 25, 50, 100, 'All'],
      });
    })
